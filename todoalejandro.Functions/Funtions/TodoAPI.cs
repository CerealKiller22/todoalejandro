...
using todoalejandro.Common.Responses;
...
namespace todoalejandro.Functions.Funtions
{
    ...
    {
        [FunctionName(nameof(CreateTodo))]  //nombre externo de la clase
        ...
        [FunctionName(nameof(UpdateTodo))]  //nombre externo de la clase
        ...
        [FunctionName(nameof(GetAllTodos))]  //nombre externo de la clase
        ...
        [FunctionName(nameof(GetTodoById))]  //nombre externo de la clase
        ...
        [FunctionName(nameof(DeleteTodo))]  //nombre externo de la clase
